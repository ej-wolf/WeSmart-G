...
import numpy as np
#local imports
from analyze_stream_motion import (DEFAULT_POOL_TOP_K_MIN, DEFAULT_POOL_TOP_K_RATIO, DEFAULT_VERSION, MOTION_FPS_MAX,
...
def build_feature_schema(**kwargs) -> dict[str, Any]:
    ...
    return {'extractor': DEFAULT_FEATURE_EXTRACTOR,
            ...
            'pool_mode'  : pool_mode,
            'pool_top_k_ratio': float(kwargs.get('pool_top_k_ratio', DEFAULT_POOL_TOP_K_RATIO)),
            'pool_top_k_min': int(kwargs.get('pool_top_k_min', DEFAULT_POOL_TOP_K_MIN)),
...
def load_cache_contract_compact(npz_path:str|Path) -> tuple[dict[str, Any], bool]:
    ...
    feature_schema = {'extractor': "N/A", 'extractor_version': "N/A",
                      ...
                      'pool_top_k_ratio': "N/A", 'pool_top_k_min': "N/A",
